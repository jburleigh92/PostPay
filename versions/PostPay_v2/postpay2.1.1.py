...
CREDENTIALS_PATH = '/Users/jasonburleigh/postpay/credentials/paymentscredentials.json'
TOKEN_PATH = '/Users/jasonburleigh/postpay/token.json'
DATABASE_PATH = '/Users/jasonburleigh/postpay/payments.db'
MOCK_DB_PATH = '/Users/jasonburleigh/postpay/mock_chat.db'
    ...
    while True:
        ...
        for notification in zelle_notifications:
            ...
            if sender_name and amount:
                ...
                if formatted_message not in posted_messages and not is_payment_logged(notification):
                    print(f"Posting to Slack: {formatted_message}")
                    post_to_slack(formatted_message)
                    log_payment({
                        'id': notification,
